...
## Hello, Im Preston <img src="https://raw.githubusercontent.com/SudhanPlayz/SudhanPlayz/master/images/WaveIcon.gif" width="30px">

```js
const Preston = {
  languages: ["JavaScript", "HTML", "CSS", "React.JS"], //And so many
  favoriteNumber: 11, //I like this number :)
  projects: [
    {
      name: "Windows10PiOS",
    ...
    {
      name: "RedditDiscordBot",
      url: "coming very soom"
    },
